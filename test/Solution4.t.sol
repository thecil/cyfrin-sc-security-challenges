...
contract Solution4Test is Test {
    ...
    address constant sepoliaChallengeAddress =
        0xf988Ebf9D801F4D3595592490D7fF029E438deCa;
    ...
    function test_canReadChallengeContract() public view {
        ...
        assertEq(
            result,
            "Section 4: Puppy Raffle Audit",
            "Should be description: Section 4: Puppy Raffle Audit"
        );
    }
    ...
    function test_owner() public {
        vm.startPrank(USER);
        (bool success, bytes memory returnData) = USER.staticcall(
        ...
        assertEq(
            ownerAddress,
            USER,
            "ownerAddress should be the same as return data"
        );
    }
}
