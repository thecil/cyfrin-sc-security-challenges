...
contract Solution0Test is Test {
    ...
    address constant sepoliaChallengeAddress = 0x39338138414Df90EC67dC2EE046ab78BcD4F56D9;
    ...
    function test_canReadChallengeContract() public view {
        ...
        assertEq(result, "Section 0: Welcome!", "Should be description: Section 0: Welcome!");
    }
