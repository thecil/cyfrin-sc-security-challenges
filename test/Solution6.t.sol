...
import { S6 } from "../src/challenges/S6/S6.sol";
import { IERC721 } from "@openzeppelin/contracts/token/ERC721/IERC721.sol";
import { Solution6 } from "../src/solutions/Solution6.sol";

contract Solution6Test is Test {
    S6 challenge;
    Solution6 solution;
    IERC721 nft;
    address constant sepoliaRegistryAddress = 0x31801c3e09708549c1b2c9E1CFbF001399a1B9fa;
    address constant sepoliaChallengeAddress = 0xcf4fbA490197452Bd414E16D563623253eFb57D3;
    ...
    function test_canReadChallengeContract() public view {
        ...
        assertEq(result, "Section 6: Thunder Loan", "Should be description: Section 6: Thunder Loan");
    }
